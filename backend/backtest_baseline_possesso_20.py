...
OUTPUT = "../data/serie_a_backtest_baseline_possesso_20.csv"
...
for b in baseline:
    ...
    if possesso_casa is None or possesso_ospite is None:
        raise RuntimeError(
            f"Possesso mancante per: {chiave}"
        )
...
# --------------------------------------------------
# Per avere 20 predizioni utilizziamo un modello
# globale stimato esclusivamente sulle feature
# PRE-PARTITA.
#
# Il baseline rimane invariato.
#
# Il modello stima la correzione associata al
# differenziale di possesso.
# --------------------------------------------------
...
# Per evitare di usare la partita stessa nella propria
# stima, facciamo Leave-One-Out.
predizioni = []
...
print("\n===== BACKTEST BASELINE + POSSESSO - 20 PARTITE =====")
